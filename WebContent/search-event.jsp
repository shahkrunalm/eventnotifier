...
<title>Search Event - Curated Event Notifier</title>
				...
				<div class="center wow fadeInDown">
					<form action="./EventController">
						<table id="table-with-padding">
							<tr>
								<td class="bold">Search Event &nbsp;&nbsp;&nbsp;&nbsp; <input type="hidden" name="action"
									value="search" /> <input type="text"
									placeholder="Search event name" name="search" > <i
				...
				<div class="row">
					<div class="col-md-4 wow fadeInDown">
						<div class="clients-comments text-center">
							...
							<h3>Lorem ipsum dolor sit amet, consectetur adipisicing
								elit, sed do eiusmod tempor incididunt</h3>
							<h4>
